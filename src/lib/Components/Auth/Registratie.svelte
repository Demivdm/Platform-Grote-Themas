<section>
    ...
    <header>
        <h1>Registratie</h1>
        <p>Registreer nu om jouw werkvorm te uploaden, favoriete werkvormen op te slaan en werkvormen te delen met collega's.</p>
    </header>

    <!-- Registratie Form -->
    <form action="/registratie" on:submit|preventDefault>
